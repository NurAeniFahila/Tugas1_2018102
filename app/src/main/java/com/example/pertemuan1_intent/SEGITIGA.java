...
public class SEGITIGA extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        hasil.setOnClickListener(new
                                         View.OnClickListener() {
                                             @Override
                                             public void onClick(View v){
                                                 if(input_alas.length()==0 ||
                                                         input_tinggi.length()==0){

                                                     Toast.makeText(getApplication(),"Alas dan Tinggi tidak boleh kosong",Toast.LENGTH_LONG).show();
                                                 } else {
                                                     double alas =
                                                             Double.parseDouble(input_alas.getText().toString());
                                                     double tinggi =
                                                             Double.parseDouble(input_tinggi.getText().toString());
                                                     double hasil =
    ...
    public double LuasSegitiga(double input_alas,
                               double input_tinggi){
